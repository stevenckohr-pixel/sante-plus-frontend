                ...
                <div class="shrink-0 text-center pt-8 pb-4">
                        <div class="flex justify-center mb-6">
                            <div class="relative">
                                ...
                                <div class="absolute inset-0 rounded-full bg-gradient-to-br from-emerald-400 to-emerald-600 opacity-20 blur-xl scale-150"></div>
                                <!-- Logo avec fond blanc et ombre portée -->
                                <div class="relative w-32 h-32 rounded-full bg-white shadow-2xl flex items-center justify-center border-4 border-emerald-100">
                                    <img id="auth-logo-img" src="/sante-plus-frontend/assets/images/logo-general-icon.png" class="w-20 h-20 object-contain">
                                </div>
                            </div>
                        </div>
